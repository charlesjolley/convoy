...
AssetPackager.prototype = Object.create(EventEmitter.prototype);
 ...
 * @return {void}
 */
AssetPackager.prototype.warn = function() {
 ...
 * @return {void}
 */
AssetPackager.prototype.error = function() {
  var args = Array.prototype.slice.call(arguments);
  args.unshift('error');
  this.emit.apply(this, args);
};
 ...
 * @return {void}
 */
AssetPackager.prototype.info = function() {
  var args = Array.prototype.slice.call(arguments);
  args.unshift('info');
  this.emit.apply(this, args);
};
...
// alias log
AssetPackager.prototype.log = AssetPackager.prototype.info;
